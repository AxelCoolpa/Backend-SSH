...
export default class AccomodationRoutes {
   ...
   private configureRoutes() {
      ...
      this.router.get(
         "/accomodation",
         this.accomodationController.getAccomodations
      );
      ...
      this.router.post(
         "/accomodation/:idUser/create/",
         this.upload.any(),
         this.accomodationController.createAccomodation
      );
      ...
      this.router.put(
         "/accomodation/:idUser/update/:idAccomodation",
         this.upload.any(),
         this.accomodationController.updateAccomodation
      );
      this.router.get("");
   }
